...
parser.add_argument('--save_interval', default=1, help='save model interval')
...
parser.add_argument('--objective_num', default=3)
parser.add_argument('--user_preference', default=None, help='None or list, for example, [0.2,0.5,0.3]')
...
class Train:
    ...
    def black_box_function(self, w1, w2, w3):
        ...
        index, hypervolume, E = compute_index(obj_np, self.point)
    ...
    def learning(self):
        for n_epi in range(args.train_step):
            ...
            w2 = rn.uniform(0, 1)
            w3 = rn.uniform(0, 1)
            index = self.black_box_function(w1, w2, w3)
            print("n_epi:", n_epi)
